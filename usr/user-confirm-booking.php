    ...
    <div id="content-wrapper">
      ...
      <?php if(isset($succ)) {?>
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Cylinder</li>
          <li class="breadcrumb-item ">Book Cylinder</li>
        ...
        ?>
          ...
          <div class="form-group">
                <label for="exampleInputEmail1">Cylinder Category</label>
                <input type="text" value="<?php echo $row->v_category;?>" readonly class="form-control" name="u_car_type">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Cylinder Size</label>
...
<div className="my-3">
    ...
    <div className="form-check">
        <input id="EVC-Plus" name="paymentMethod" type="radio" className="form-check-input" required="" />
        <label className="form-check-label" htmlFor="EVC-Plus">EVC-Plus</label>
    </div>
  

    <div className="col-md-6">
        <label htmlFor="cc-number" className="form-label">Mobile number</label>
        <input type="text" className="form-control" id="cc-number" placeholder="+252618586260" required="" />
...
<hr className="my-4" />
            <div class="form-group">
                ...
                <input type="datetime-local"class="form-control" id="exampleInputEmail1"  name="u_car_bookdate">
            </div>
