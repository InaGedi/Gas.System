...
<head>
  ...
  <title>Online Gas Selling System - Admin Dashboard</title>
            ...
            <div class="card text-white bg-danger o-hidden h-100">
              <div class="card-body">
                ...
                <?php
                  ...
                  $stmt->close();
                ?>
                <div class="mr-5"><span class="badge badge-danger"><?php echo $driver;?></span> delivery persons</div>
              </div>
            ...
            <div class="card text-white bg-danger o-hidden h-100">
              <div class="card-body">
                ...
                <?php
                  ...
                  $stmt->close();
                ?>
                <div class="mr-5"><?php echo $vehicle;?></span> Cylinders</div>
              </div>
