    ...
    <div id="content-wrapper">
      ...
      <?php if(isset($succ)) {?>
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Update cylinder</li>
        </ol>
        <hr>
        <div class="card">
        ...
        ?>
          <form method ="POST" enctype="multipart/form-data"> 
            ...
            <div class="form-group">
                <label for="exampleInputEmail1">delivery persons</label>
                <input type="text" value="<?php echo $row->v_driver;?>" class="form-control" id="exampleInputEmail1" name="v_driver">
            </div>
            
            <div class="form-group">
              <label for="exampleFormControlSelect1">cylinder Category</label>
              <select class="form-control" name="v_category" id="exampleFormControlSelect1">
                <option>cylinder for Home</option>
                <option>cylinder for Home</option>
                <option>cylinder for Hotels and restruents</option>

              </select>
            </div>

            <div class="form-group">
              <label for="exampleFormControlSelect1">cylinder Status</label>
            ...
            <div class="card-body">
                <h5 class="card-title">cylinder Picture</h5>
                <input type="file" class="btn btn-success" id="exampleInputEmail1" name="v_dpic">
            </div>
            </div>
            <hr>
            <button type="submit" name="upate_veh" class="btn btn-success">Update cylinder</button>
          </form>
          <!-- End Form-->
          <?php }?>
        </div>
