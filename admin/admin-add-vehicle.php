      ...
      <?php if(isset($succ)) {?>
        ...
        <div class="card-body">
          ...
          <form method ="POST" enctype="multipart/form-data"> 
            ...
            <div class="form-group">
                <label for="exampleInputEmail1">cylinder price</label>
                <input type="text" class="form-control" id="exampleInputEmail1" name="v_pass_no">
            </div>
            <div class="form-group">
              <label for="exampleFormControlSelect1">Dilieved person</label>
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="v_category" id="exampleFormControlSelect1">
                ...
                <option>cylinder for Home</option>
                <option>cylinder for Home</option>
                <option>cylinder for Hotels and resturants</option>
            ...
            <div class="form-group col-md-12">
                <label for="exampleInputEmail1">cylinder Picture</label>
                <input type="file" class="btn btn-success" id="exampleInputEmail1" name="v_dpic">
            </div>

            <button type="submit" name="add_veh" class="btn btn-success">Add cylinder</button>
          </form>
          <!-- End Form-->
        </div>
      </div>
